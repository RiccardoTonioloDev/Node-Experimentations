...
const Schema = mongoose.Schema; //Questo è l'oggetto che mongoose ci da per definire uno schema

// Qui sotto stiamo definendo lo schema dei prodotti
const productSchema = new Schema({
    title: {
        type: String,
        required: true, // In questo modo forziamo il fatto che un prodotto deve avere un prodotto
    },
    price: {
        type: Number,
        required: true,
    ...
    userId: {
        ...
        ref: "User", //Uso il nome con cui ho definito lo user nella funzione .model()
        required: true,
    },
});

module.exports = mongoose.model("Product", productSchema);
// IL primo parametro è come si deve chiamare la collezione, mentre il secondo
// serve a definire lo schema di quella particolare collezione.

// // const getDb = require("../util/database").getDb; //Ora usiamo mongoose
